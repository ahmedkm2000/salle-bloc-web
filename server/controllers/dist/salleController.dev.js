...
var insertoccupation = function insertoccupation(req, res) {
  var occupations, count, d, date, i, occupation, result, inserted, socket, salles;
      ...
      switch (_context15.prev = _context15.next) {
        ...
        case 2:
          ...
          for (i = 0; i < occupations.length; i++) {
            if (occupations[i].salle == req.body.salle && occupations[i].date == date && occupations[i].time == req.body.time) {
              count++;
            }
          }
